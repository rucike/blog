...
Route::middleware(['auth'])->group(function () {
    ...
    // delete comment
    Route::post('comment/delete/{id}', [CommentsController::class, 'destroy']);
  });
  
  // vartotojo profilis
  Route::get('user/{id}', [UserController::class, 'profile'])->where('id', '[0-9]+')->name('user/'.Auth::id());
  // rodomas konkretus vartotojo irasas
 ...
 Route::get('/{slug}', [PostsController::class, 'show'])->where('slug', '[A-Za-z0-9-_]+')->name('show');