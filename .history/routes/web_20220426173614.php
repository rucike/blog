...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('my-all-posts', [UsersController::class, 'user_posts_all'])->name('my-all-posts');
    // display user's drafts
    Route::get('my-drafts', [UsersController::class, 'user_posts_draft']);
    // add comment
  ...
  //users profile
  Route::get('user/{id}', [UsersController::class, 'profile'])->where('id', '[0-9]+')->name('user/'.Auth::id());
