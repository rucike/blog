    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    @endsection
                @if ( !$posts->count() )
                    <div class="p-2">{{ __('There is no post till now. Login and write a new post now') }}!!!</div>
                @else
                    <div class="overflow-hidden shadow-sm sm:rounded-lg p-2" style="background-color:#e6e6e6;">
