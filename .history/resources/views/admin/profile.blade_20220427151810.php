...
@section('content')
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item panel-body" style="background-color:#f2f2f2;">
                <table class="table-padding">
                    ...
                    <td><a href="{{ url('/my-all-posts')}}" class="btn" style="background-color:#c2c2f0;">Show All</a></td>
                    @endif
                    </tr>
                    <tr>
                    ...
                    <td><a href="{{ url('/user/'.$user->id.'/posts')}}" class="btn" style="background-color:#c2c2f0;">Show All</a></td>
                    @endif
                    </tr>
                    <tr>
                    ...
                    <td><a href="{{ url('my-drafts')}}" class="btn" style="background-color:#c2c2f0;">Show All</a></td>
                    @endif
                    </tr>
                </table>
            </li>
    ...
    <div class="panel panel-default sm:rounded-lg mt-2 p-2" style="background-color:#f2f2f2;">
        <div class="panel-heading underline"><h3>Latest Posts</h3></div>
    ...
    <div class="panel panel-default sm:rounded-lg mt-2 p-2 bg-">
        <div class="panel-heading underline"><h3>Latest Comments</h3></div>
