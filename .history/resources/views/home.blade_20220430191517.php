    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                    ...
                    @endsection
                @if ( !$posts->count() )
                    <div class="p-2">{{ __('There is no post till now. Login and write a new post now') }}!!!
                @else
                    <div class="overflow-hidden shadow-sm sm:rounded-lg" style="background-color:#e6e6e6;">
                        ...
                        <div class="list-group m-2">
                            <div class="list-group-item" style="background-color:#BBADA0;">
                                ...
                                <p>{{ $post->created_at->format('Y-m-d, H:i') }} By <a href="{{ url('/user/'.$post->author_id)}}">{{ $post->author->name }}</a></p>
