...
-->
<body class="bg-white" style="background-image: url('{{ asset('assets/images/b2b/graph-01.svg')}}');">
    @include('layouts.navigation')  
    <div class="container shadow-lg" style="padding:1em; background-color:#36527c;">
        <div class="panel-heading sm:rounded-lg mb-2" style="background-color:#BBADA0;">
