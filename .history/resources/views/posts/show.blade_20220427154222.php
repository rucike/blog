...
@section('content')
    @if($post)
        ...
        <div style="background-color:#f2f2f2;" class="mt-3 sm:rounded-lg p-2">   
            <div>
            ...
            @else
                <div class="panel-body">
                    <form method="post" action="{{ url('/comment/add') }}">
                        ...
                        <input type="submit" name='post_comment' class="btn btn-success" style="background-color:#d279a6;" value = "Post"/>
                    </form>
                </div>
            @endif
            <div>
